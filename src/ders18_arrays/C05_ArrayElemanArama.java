...
public class C05_ArrayElemanArama {
    public static void main(String[] args) {
        ...
        int [] arr={1,2,3,4,5,6,7,4,2,3,5,1,3,2};
        int arananEleman=2;
    ...
    public static void elemanAra(int[]arr,int arananEleman) {
        ...
        if (sayac==0){
            System.out.println("Aranan sayı kullanılmamıştır");}
        else {
            System.out.println("aranan eleman "+arananEleman+" dizide "+sayac+" kez kullanımıştır");
        }
    }
}
