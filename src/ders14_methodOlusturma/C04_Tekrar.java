...
public class C04_Tekrar {
    public static void main(String[] args) {
        ...
        System.out.println(C02_StringConcate.birlestirmeMethodu(c, d)); // Nasil yani?

        String e= "Bu da mi oldu?";
        // e String'ini tersten yazdirin
        System.out.println(C03_StringTerseCevirme.stringTersCevir(e));


        // "Bu cumleyi terse cevirin"

        System.out.println(C03_StringTerseCevirme.stringTersCevir("Bu cumleyi terse cevirin"));
